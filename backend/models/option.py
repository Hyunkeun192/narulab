...
class Option(Base):
    ...
    option_id = Column(String(36), primary_key=True, default=lambda: str(uuid4()))  # 선택지 고유 ID
    question_id = Column(String(36), ForeignKey("questions.question_id"), nullable=False)  # 소속 문항 ID
