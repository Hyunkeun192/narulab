// src/pages/school/reports/ReportList.jsx

import React, { useEffect, useState } from "react";
import axios from "axios";

// ✅ 학교 관리자 전용 리포트 리스트 페이지
export default function ReportList() {
    ...
    useEffect(() => {
        const fetchReports = async () => {
            try {
                const res = await axios.get("/api/school/reports", {
                    headers: {
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-10">
            <h1 className="text-2xl font-bold mb-6">소속 학생 검사 리포트</h1>
